...
## 二層構成
- 正本（主人が読む）: `$HOME/Vault/ada_worklog/YYYY-MM-DD.md`（**日次**・追記専用・Obsidian。
...
```
uv run --project $HOME/.claude/skills/worklog \
  python $HOME/.claude/skills/worklog/scripts/worklog.py \
